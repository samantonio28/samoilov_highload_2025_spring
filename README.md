...
$R_{A новый} = R_A + K × (O_A - P_A) \newline R_{B новый} = R_B + K × (O_B - P_B),$
где:
...
3) Создается хранилище рейтингов пользователей
...
--
- Динамический коэффициент $K$: для новых пользователей используется больший $K$ для быстрой адаптации, для опытных - меньший для стабильности
